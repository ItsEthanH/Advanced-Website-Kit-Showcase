...
window.shopify.productId = document.querySelector("[data-product-id")?.dataset.productId;
// Automatically uses the CodeStitch --primary color to style the cart toggle and checkout buttons
window.shopify.primaryColor = getComputedStyle(document.documentElement).getPropertyValue("--primary");
